...
<table>
    <tr>
        ...
        <th>Ward</th>
        <th>Constituency</th>
        <th>Average Report of other crops</th>
    </tr>
    <?php
    ...
    $sql = "SELECT location, ward, constituency, AVG(land_size_other_crops) AS average_yield FROM kim GROUP BY location, ward, constituency";
